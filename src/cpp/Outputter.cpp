...
=======
					Beam_mises = sqrt(beamstress[0] * beamstress[0] + beamstress[1] * beamstress[1] + beamstress[2] * beamstress[2] - (beamstress[0] * beamstress[1] + beamstress[1] * beamstress[2] + beamstress[2] * beamstress[0]));
>>>>>>> 6245da6a00e6a55d4fb5d273becf0b065f3b494b
