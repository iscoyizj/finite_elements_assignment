...
for mtyp1 in MN_MTYP_dict.keys():
	if mtyp1 =="test":
		...
		AREA=float(mtyp1[1])
		g.write(str(N)+" "+str(E)+" "+str(AREA)+" "+str(density)+"\n")
...
for mtyp1 in MN_MTYP_dict.keys():
	if mtyp1 =="test":
		...
		density=float(material_density_dict[mtyp1])
...
for data_8 in T3D2_output_data:
	...
	g.write(str(M)+" "+str(II1)+" "+str(II2)+" "+str(II3)+" "+str(II4)+" "+str(JJ1)+" "+str(JJ2)+" "+str(JJ3)+" "+str(JJ4)+" "+str(MTYP)+"\n")
NPAR1=3
...
for data_8 in T3D2_output_data:
	...
	MN=data_8[3:5]
	MTYP=MN_MTYP_dict[MN[0],MN[1]]
	g.write(str(M)+" "+str(II1)+" "+str(II2)+" "+str(JJ1)+" "+str(JJ2)+" "+str(MTYP)+"\n")
NPAR1=4
...
for mtyp1 in MN_MTYP_dict.keys():
	if mtyp1 =="test":
		...
		g.write(str(N)+" "+str(E)+" "+str(poisson)+" "+str(density)+" "+str(data11)+" "+str(data12)+" "+str(data13)+" "+str(data14)+" "+str(data21)+" "+str(data23)+" "+str(data22)+" "+"\n")
for data_8 in T3D2_output_data:
	M=data_8[0]
	II=data_8[1]
	JJ=data_8[2]
